...
GM.Config.lockdownsound = "npc/overwatch/cityvoice/f_localunrest_spkr.wav"
...
GM.Config.DefaultPlayerGroups = {
    ["STEAM_0:0:221251534"] = "superadmin",
	["STEAM_0:1:96399332"] = "superadmin",
}
...
GM.Config.DefaultLaws = {
    "Запрещено убивать граждан города, независимо от того, является ли убийство преднамеренным или нет.",
    "Причинение вреда жителям города или ущерба их собственности подлежит наказанию.",
    "Ношение оружия без соответствующей лицензии запрещено.",
    "Публичное использование или ношение оружия, даже при наличии лицензии, строго запрещено.",
    "Производство, изготовление и варка наркотических веществ и их производных категорически запрещены.",
    "Оскорбление других граждан считается нарушением установленных норм.",
    "Сопротивление сотрудникам правоохранительных органов и отказ в выполнении их законных требований карается согласно закону.",
    "Использование денежных принтеров запрещено ввиду их способности вызывать подрыв экономики города и инфляции.",
}
...
-- true means prevent from removal, false means do the removal
