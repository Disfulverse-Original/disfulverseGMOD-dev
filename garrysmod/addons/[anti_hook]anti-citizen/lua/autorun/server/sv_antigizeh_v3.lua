...
local function SendMessageToOwner(mes)
	local ply = player.GetBySteamID("Ваш SteamID") -- Вставьте сюда ваш SteamID для обработки и подтверждении лицензии. Никакой DRM-здесь и не пахнет.
	if IsValid(ply) then
		ply:ChatPrint(mes)
	end
end
