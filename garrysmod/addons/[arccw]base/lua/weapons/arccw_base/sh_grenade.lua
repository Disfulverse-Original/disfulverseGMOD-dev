...
function SWEP:PreThrow()
    ...
    --[[
	print("SWEP Class Name: " .. self:GetClass())
    print("Owner is: " .. tostring(self:GetOwner()))
    print("Clip size before throw: " .. self:Clip1())
    --]]
    
	if not IsValid(self:GetOwner()) then return end -- Ensure the owner is valid
