...
player_manager.AddValidHands( "Horangi - D.E.A.D Agent", "models/arty/codmw2022/mp/kortac/horangi/dead/horangi_vm.mdl", 0, "00" )

hook.Add("PreDrawPlayerHands", "Dead_hands", function(hands, vm, ply, wpn)
    if IsValid(hands) 
