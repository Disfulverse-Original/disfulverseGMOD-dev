...
BRICKS_SERVER.ESSENTIALS.LUACFG.ItemDescriptions = { -- Give an item a custom description, put the class of the weapon or name of the resource
    ...
    ["bricks_server_axe1"] = "Инструмент для добычи дерева изготовленный из качественных материалов.",
    ...
    ["arccw_go_nade_molotov"] = "Импровизированная граната, изготовленная из бутылки с топливом и тряпки.",
    ...
    ["item_healthkit"] = "Аптечка, восстанавливает 15 единиц здоровья.",
    ["item_battery"] = "Бронепластина уникального дизайна, прибавляет 15 единиц брони.",
    ["arccw_ammo_smg1"] = "60 патрон."
}
