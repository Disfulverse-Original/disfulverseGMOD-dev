    ...
    function shopPanel.FillShop()
        ...
        for k, v in ipairs( ShopOrdered ) do
            ...
            if( not categories[itemCategory] ) then
                categories[itemCategory] = shopPanel:Add( itemCategory, categoryTable.color or BRICKS_SERVER.Func.GetTheme( 4 ), Color(3, 3, 3, 5) )
            ...
            itemBack.Paint = function( self2, w, h )
                draw.RoundedBox( 0, 0, 0, w, h, Color(4, 4, 6, 45) ) -- BRICKS_SERVER.Func.GetTheme( 3 )

                surface.SetDrawColor( Color(4, 4, 6, 45) )
