...
function PANEL:Init()
	...
	for k, v in pairs( itemTable ) do
		...
		itemAction.Paint = function( self2, w, h )
			...
			draw.SimpleText( "Экипировать", "BRICKS_SERVER_Font25", w/2, h/2, BRICKS_SERVER.Func.GetTheme( 6 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
...
function PANEL:Paint( w, h )
    ...
    draw.SimpleText( "Оружейный шкаф", "BRICKS_SERVER_Font30", 10, 40/2-2, BRICKS_SERVER.Func.GetTheme( 6 ), 0, TEXT_ALIGN_CENTER )
end
