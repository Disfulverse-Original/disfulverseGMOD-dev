...
onyx.cfg.colors = {}
--onyx.cfg.colors.primary = Color(38, 39, 46, 225)
onyx.cfg.colors.primary = hexcolor('#26272E')

--onyx.cfg.colors.secondary = Color(42, 44, 51, 200)
onyx.cfg.colors.secondary = hexcolor('#2A2C33')

--onyx.cfg.colors.tertiary = Color(48, 50, 59, 175)
onyx.cfg.colors.tertiary = hexcolor('#30323B')

--onyx.cfg.colors.quaternary = Color(38, 39, 46, 150)
onyx.cfg.colors.quaternary = hexcolor('#26272E')

onyx.cfg.colors.accent = Color(245, 245, 245)
