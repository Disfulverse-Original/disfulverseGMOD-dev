...
local font0 = onyx.Font('Roboto@16')
local font1 = onyx.Font('Roboto@20')
local font2 = onyx.Font('Roboto@16')
local font3 = onyx.Font('Roboto@14')
...
function PANEL:AddOption(option)
    ...
    if (not categoryPanel) then
        ...
        categoryPanel:SetTitle(category:upper())
    ...
    if (option.combo) then
        ...
        for i, opt in pairs(option.combo) do
