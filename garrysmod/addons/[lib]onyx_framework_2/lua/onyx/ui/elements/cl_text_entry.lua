...
function PANEL:Init()
    ...
    self.textEntry.Paint = function(panel, w, h)
        panel:DrawTextEntryText(panel:GetTextColor(), colorAccent, color_white)
    end
    ...
    self:SetFont(onyx.Font('Roboto@16'))
    self:SetTextColor(color_white)
    -- self:SetPlaceholderFont(onyx.Font('Roboto@16', 'italic:true'))
    ...
    self.currentOutlineColor = onyx.CopyColor(colorSecondary)
end
...
function PANEL:OnGetFocus()
    ...
    onyx.anim.Simple(self, .25, {
        focusAnimFraction = 1,
        currentOutlineColor = colorAccent
    }, 1, nil, nil, 'inQuad')
end
...
function PANEL:OnLoseFocus()
    ...
    onyx.anim.Simple(self, .25, {
        focusAnimFraction = 0,
        currentOutlineColor = colorSecondary
    }, 1, nil, nil, 'outQuad')
end
