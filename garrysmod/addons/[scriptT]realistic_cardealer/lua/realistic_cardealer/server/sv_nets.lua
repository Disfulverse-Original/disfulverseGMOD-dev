...
net.Receive("RCD:Admin:Configuration", function(len, ply)
    ...
    elseif uInt == 3 then
        ...
        local vehiclePrice = net.ReadUInt(32)
        ...
        if not isnumber(vehiclePrice) or vehiclePrice < 0 then ply:RCDNotification(5, RCD.GetSentence("invalidVehiclePrice")) return end
    ...
    elseif uInt == 5 then
        ...
        RCD.CreateNPC(npcId, npcName, npcModel, pos, ang, plateforms, groups, string.lower(game.GetMap()))
