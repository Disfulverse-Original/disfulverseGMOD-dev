...
AAS.WeightInventory = {
    ["all"] = 100, -- don't touch to the name of the category !!!!
    ["VIP"] = 10,
}

AAS.ItemNpcModel = "models/Humans/Group02/male_02.mdl"

AAS.ItemNpcName = "Аксессуары"

AAS.BodyGroupModel = "models/props_c17/FurnitureDresser001a.mdl"

AAS.BodyGroupsName = "Смена одежды"
...
AAS.Colors = {
    ...
    ["disfulpurple"] = Color(67, 54, 89, 255),
}
