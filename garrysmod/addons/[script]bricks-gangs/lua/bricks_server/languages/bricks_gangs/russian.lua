BRICKS_SERVER.Func.AddLanguageStrings( "russian", {
    ...
    ["gangClaimed"] = "Захвачено",
    ["gangUnclaimed"] = "Не захвачено",
    ["gangClaimedAgo"] = "Захвачено %s назад",
    ["gangRewardsEvery"] = "Награда каждые: %s",
    ...
    ["gangTerritoryBeingCaptured"] = "Ваша территория: %s кем-то сейчас захватывается!",
    ["gangXMessage"] = "%d Сообщение",
    ["gangXMessages"] = "%d Сообщений",
    ["gangInfo"] = "Информация о банде",
    ["gangMessageDisabled"] = "Чат банды на данный момент выключен.",
    ["gangPrinters"] = "Принтеры",
    ["gangPurchasePrinters"] = "Купить принтеры",
    ["gangUpgradePrinters"] = "Улучшить принтеры",
    ["gangPlacePrinters"] = "Поставить принтеры",
    ["gangPrinterUpgrades"] = "Улучшения принтеров",

    ["gangRankLimit"] = "Вы достигли лимита рангов: %d!",
    ["gangRankLowLimit"] = "Вы должны иметь хотя бы 1 ранг!"
