...
function PANEL:FillPanel( gangTable )
    ...
    function self.RefreshPanel()
        ...
        for k, v in pairs( BRICKS_SERVER.CONFIG.GANGPRINTERS.Printers ) do
            ...
            local textX, textY = surface.GetTextSize( "Не куплено" )
            ...
            if( not printerTable and LocalPlayer():GangHasPermission( "PurchasePrinters" ) ) then
                ...
                local textX, textY = surface.GetTextSize( "Купить" )
                ...
                purchaseButton.Paint = function( self2, w, h ) 
                    ...
                    draw.SimpleText( "Купить", "BRICKS_SERVER_Font30", w/2, h/2+4, BRICKS_SERVER.Func.GetTheme( 6 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
            ...
            elseif( printerTable and LocalPlayer():GangHasPermission( "PlacePrinters" ) ) then
                surface.SetFont( "BRICKS_SERVER_Font30" )
                local textX, textY = surface.GetTextSize( "Поставить" )
                ...
                placeButton.Paint = function( self2, w, h ) 
                    ...
                    draw.SimpleText( "Поставить", "BRICKS_SERVER_Font30", w/2, h/2+4, BRICKS_SERVER.Func.GetTheme( 6 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
                ...
                for i = 1, BRICKS_SERVER.DEVCONFIG.GangPrinterSlots do
                    ...
                    slotButton.Paint = function( self2, w, h ) 
                        ...
                        if( not purchased ) then
                            ...
                            draw.SimpleText( "Купить", "BRICKS_SERVER_Font13", w/2, h/2+1.5, BRICKS_SERVER.Func.GetTheme( 6 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
                            ...
                            draw.SimpleText( "Куплено", "BRICKS_SERVER_Font13", w/2, h/2, headerColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                        end
                    end
                    ...
                    if( val.Tiers ) then
                        ...
                        slotButton.Paint = function( self2, w, h ) 
                            ...
                            if( not purchased ) then
                                ...
                                draw.SimpleText( "Купить", "BRICKS_SERVER_Font13", w/2, h/2, BRICKS_SERVER.Func.GetTheme( 6 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                            else
                                draw.SimpleText( "Куплено", "BRICKS_SERVER_Font13", w/2, h/2, headerColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                            end
                        end
