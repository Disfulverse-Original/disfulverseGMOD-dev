...
function ENT:CreateVGUI()
	...
	if( not IsValid( self.printerVGUI )  ) then
		...
		healthPanel.Paint = function( self2, w, h )
			...
			draw.SimpleText( "Целостность", "BRICKS_SERVER_NoSC_Font24", 23*0.8, 15*0.8, Color( 255, 255, 255, 25 ), 0, 0 )
		...
		-- Progress Bars
		local ProgressBars = {}
		table.insert( ProgressBars, { "ДЕНЕГ", function() 
			return DarkRP.formatMoney( self:GetHolding() or 0 )
		end, function()
			return 1
		end, true } )

		table.insert( ProgressBars, { "ДОХОД", function() 
			return DarkRP.formatMoney( math.Round(self:GetPrintAmount()) ) .. " / " .. self:GetPrintTime() .. "s"
		end, function()
		...
		table.insert( ProgressBars, { "ТЕМПЕРАТУРА", function() 
		...
		graphPanel.Paint = function( self2, w, h )
			...
			draw.SimpleText( "ДОХОД", "BRICKS_SERVER_NoSC_Font24", 23, 21, Color( 255, 255, 255, 25 ), 0, 0 )
		end
		...
		bottomLeftPanel.Paint = function( self2, w, h )
			...
			draw.SimpleText( "ИСТОРИЯ", "BRICKS_SERVER_NoSC_Font24", 23, 21, Color( 255, 255, 255, 25 ), 0, 0 )
		end
		...
		toggleButton.Paint = function( self2, w, h )
			...
			draw.SimpleText( "ВКЛ.", "BRICKS_SERVER_NoSC_Font20", w/4, h/2, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
			draw.SimpleText( "ВЫКЛ.", "BRICKS_SERVER_NoSC_Font20", w/4*3, h/2, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		withdrawButton.Paint = function( self2, w, h )
			...
			draw.SimpleText( "ВЫВЕСТИ ДЕНЬГИ", "BRICKS_SERVER_NoSC_Font20", w/2, h/2, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		...
		menuPanel.Paint = function( self2, w, h )
			...
			draw.SimpleText( "МЕНЮ", "BRICKS_SERVER_NoSC_Font24", 23, 21, Color( 255, 255, 255, 25 ), 0, 0 )
		end
