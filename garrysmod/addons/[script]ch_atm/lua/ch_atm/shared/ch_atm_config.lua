...
--]]
CH_ATM.Config.Language = "ru" -- Set the language of the script.
...
CH_ATM.Config.WalletLooseOnDeathPercentage = 5 -- How many percetange of the players wallet to loose on death (not bank account)? Set to 0 to disable.
CH_ATM.Config.MaximumToLooseOnDeath = 999999 -- How much money can a player maximum loose on death?
...
CH_ATM.Config.HackingPoliceOfficersRequired = 1 -- How many online players must be police officer in order to lockpick ATMs?
...
CH_ATM.Config.PlayerWantedTime = 900 -- For how long should we make him wanted?
