...
-- Bitminer Shelf
CH_Bitminers.Config.DefaultBitcoinsMinedPer = 0.016 -- Amount of bitcoins mined on each interval by default (any rank that is not in the table below will fallback to this.
...
-- Fuel Canisters
CH_Bitminers.Config.FuelCanSmallAmount = 55 -- Amount of fuel the small canister contains (max is 100)
...
CH_Bitminers.Config.FuelGeneratorSoundLevel = 50 -- Sound level of the fuel generator when powered on. (0 = muted)

CH_Bitminers.Config.GeneratorWattsMin = 7 -- Minimum amounts of watts generated per interval
CH_Bitminers.Config.GeneratorWattsMax = 35 -- Maximum amounts of watts generated per interval (IT'S RANDOMIZED)
...
CH_Bitminers.Config.TemperatureInterval = 10 -- Interval between updating temperature on miners in seconds
CH_Bitminers.Config.TempToAddPerMiner = 0.14 -- Temperature added per miner on the shelf.

CH_Bitminers.Config.TempToTakePerCooling = 0.5 -- Temperature removed from shelf per cooling upgrade installed.
CH_Bitminers.Config.TempToTakeWhenOff = 2 -- Temperature to remove every interval if the shelf is turned off.

-- Donator Features
CH_Bitminers.Config.MaxBitminersInstalled = {
	{ UserGroup = "user", MaxBitminers = 16 },
	{ UserGroup = "vip", MaxBitminers = 16 },
	{ UserGroup = "admin", MaxBitminers = 16 },
	{ UserGroup = "superadmin", MaxBitminers = 16 },
	{ UserGroup = "owner", MaxBitminers = 16 },
}
