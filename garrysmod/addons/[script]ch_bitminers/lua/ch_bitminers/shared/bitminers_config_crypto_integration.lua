...
CH_Bitminers.Config.IntegrateCryptoMinedPer = {
	{ Usergroup = "vip", MinedPerInterval = 200 },
	{ Usergroup = "gold_member", MinedPerInterval = 300 },
	{ Usergroup = "admin", MinedPerInterval = 400 },
	{ Usergroup = "superadmin", MinedPerInterval = 500 },
	{ Usergroup = "owner", MinedPerInterval = 600 },
}