...
CH_Bitminers.Config.Lang["Your bitmining shelf is overheating!"] = {
	...
	["de"] = "Dein Bitminerschrank überhitzt!",
...
CH_Bitminers.Config.Lang["You've reached the maximum amount of UPS upgrades for this mining shelf!"] = {
	...
	["fr"] = "Mettez à niveau avec une autre alimentation pour installer plus de mineurs.",
...
CH_Bitminers.Config.Lang["You've reached the highest level of ventilation on your miner."] = {
	...
	["de"] = "Du hast das höchste Level für Belüftung erreicht.",
...
CH_Bitminers.Config.Lang["RGB lightning upgrade has been successfully installed!"] = {
	["en"] = "RGB lightning upgrade has been successfully installed!",
...
CH_Bitminers.Config.Lang["You have ejected a bitminer. It has been spawned next to you."] = {
	...
	["de"] = "Sie haben einen Bitminer ausgeworfen. Es wurde neben dir gespawnt.",
...
CH_Bitminers.Config.Lang["The bitminer already has a power source connected!"] = {
	...
	["de"] = "Der Bitminer ist bereits an eine Energiequelle angeschlossen!",
...
CH_Bitminers.Config.Lang["All bitcoin rate screens have been saved!"] = {
	...
	["de"] = "Alle Bitcoin-Ratenbildschirme wurden gespeichert!",
...
CH_Bitminers.Config.Lang["They have been added to your crypto wallet."] = {
	...
	["de"] = "Sie wurden Ihrer Krypto-Wallet hinzugefügt.",
...
-- THE SHELF 3D2D SCREEN DOES NOT HAVE LANGUAGE SUPPORT DUE TO POSSIBLE OVERLAPPING TEXT THAT COULD CAUSE
