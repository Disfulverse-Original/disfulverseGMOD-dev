...
function ENT:DrawTranslucent()
	...
	cam.Start3D2D( Pos, Ang, 0.015 )
		draw.SimpleText( CH_Bitminers.Config.Lang["Dirt"][CH_Bitminers.Config.Language] .." - ".. self:GetDirtAmount() .."%", "BITMINER_ScreenText30b", 350, 0, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
