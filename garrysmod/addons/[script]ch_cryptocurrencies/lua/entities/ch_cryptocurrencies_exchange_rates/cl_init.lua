...
local arrow_up = Material( "materials/craphead_scripts/ch_cryptocurrencies/gui/increase.png", "noclamp smooth" )
local arrow_down = Material( "materials/craphead_scripts/ch_cryptocurrencies/gui/decrease.png", "noclamp smooth" )
