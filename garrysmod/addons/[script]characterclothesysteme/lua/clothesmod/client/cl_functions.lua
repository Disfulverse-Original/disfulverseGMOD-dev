...
function CM_CreateClothes( infos, id )
	...
	if not CLOTHESMOD.Male or not CLOTHESMOD.Male.EditableTop or not CLOTHESMOD.Male.EditableTop[infos.baseTexture] then return end
	...
	local posx =  CLOTHESMOD.Male.EditableTop[infos.baseTexture].posx
	local posy =  CLOTHESMOD.Male.EditableTop[infos.baseTexture].posy
	local sizex =  CLOTHESMOD.Male.EditableTop[infos.baseTexture].sizex
	local sizey =  CLOTHESMOD.Male.EditableTop[infos.baseTexture].sizey

	

	hook.Add( "PostRender", "CLOTHESMOD_PostRender"..id, function()
		hook.Remove( "PostRender", "CLOTHESMOD_PostRender"..id )
