...
local iconMat = Material( "materials/clothesmod/icon.png" )

hook.Add("HUDPaint", "ClothesMod.HUDNotifications", function()
...
net.Receive("ClothesMod:NotifyPlayer", function()
