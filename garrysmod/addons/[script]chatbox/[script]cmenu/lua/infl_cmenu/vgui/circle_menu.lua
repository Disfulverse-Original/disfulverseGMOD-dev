...
local rightClick = Material("disfulvers/rmb.png","smooth")
local leftClick = Material("disfulvers/lmb.png","smooth")
...
hook.Add("OnContextMenuClose","infl.Cmenu",function() if ValidPanel(PIS.RadialMenu) then PIS.RadialMenu:Close() end end)
	...
	inflexible.hud:CreateFont("icon",26,"Cambria",400)
	inflexible.hud:CreateFont("base",36,"Cambria",700)
	inflexible.hud:CreateFont("small",20,"Cambria",700)
	inflexible.hud:CreateFont("notify",26,"Cambria",700)
	inflexible.hud:CreateFont("safezone",40,"Cambria",700)
	inflexible.hud:CreateFont("safezone_small",30,"Cambria",500)
	inflexible.hud:CreateFont("entitydisplay",170,"Cambria",1600)
	inflexible.hud:CreateFont("wsel",24,"Cambria",600)
	inflexible.hud:CreateFont("wsel-small",19,"Cambria",500)
	inflexible.hud:CreateFont("ban",52,"Cambria",800)
