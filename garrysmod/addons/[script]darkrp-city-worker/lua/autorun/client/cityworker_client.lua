...
net.Receive( "CITYWORKER.NotifyTask", function()
    ...
    hook.Add( "HUDPaint", "CITYWORKER.Task.HUDPaint", function()
        ...
        draw.SimpleTextOutlined( math.ceil( ( LocalPlayer():GetPos():Distance( pos ) / 16 ) / 3.28084 ).."m", "FontCitywork", screenPos.x, screenPos.y + 16, Color( 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    end )
end )
