...
local MAIN_TAB = {
	Init = function(self)
		...
		self.BtnColorPicker:SetVisible(false)
	...
	PerformLayout = function(self, w, h)
		...
		self.TextEntry:SetSize(w - self.BtnSwitch:GetWide() - self.BtnEmotePicker:GetWide(), text_entry_height)
		self.TextEntry:SetPos(self.BtnSwitch:GetWide(), h - text_entry_height)

		self.BtnSwitch:SetPos(0, h - text_entry_height)
		self.BtnEmotePicker:SetPos(w - self.BtnEmotePicker:GetWide(), h - text_entry_height)
		self.BtnColorPicker:SetPos(w, h - text_entry_height)
	end,
