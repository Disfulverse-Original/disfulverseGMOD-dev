...
function ENT:Draw()
    ...
    if LocalPlayer():GetPos():DistToSqr(self:GetPos()) < 50000 then
        ...
        draw.RoundedBox(0, -500, -320, 1000, 20, Color(255, 215, 0, 255))
        draw.DrawText("Жидкая сера ("..self:GetNWInt("amount").." л)", "methFont", 0, -425, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER);
        cam.End3D2D()
    end;
end;
