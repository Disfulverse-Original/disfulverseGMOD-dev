    ...
    function Executioner.PaintDisplay()
        ...
        Graphics.DrawText( Executioner.Config.EnableHitTime and Executioner.Config.Time_Left .. SecondsToClock( LocalPlayer():GetNWInt( 'rHit_HitTime', 0 ) ) or Executioner.Config.Active_Hit, 'rHit.Font.HUD', ScrW() - 220, 90, Color( 128, 79, 79 ) )
        ...
        if Executioner.Config.EnableDistance then
            ...
            Graphics.DrawText( Executioner.Config.Distance_Text, 'rHit.Font.HUD', ScrW() - 395, 200, Color( 255, 255, 255 ), TEXT_ALIGN_LEFT )
