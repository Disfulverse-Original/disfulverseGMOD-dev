    ...
    Executioner.Config.Language[ 'russian' ] = {
        HitPriceFormatError = 'Возникла ошибка с ценой заказа. Максимум %s - Минимум %s.',
        HitPriceCantAfford = 'Вы не можете позволить себе такой заказ, так как это будет стоить %s, а вы имеете лишь %s.',
        BonusWeaponAccepted = 'DEPRECATED',
        HitTimeReached = '%s Время, данное на выполнение заказа истекло. Заказ провален!',
        HitTooSoon = 'Слишком рано для заказа.',
        HitmanBusy = '%s уже выполняет заказ.',
        RequestSent = 'Ваш заказ был отправлен %s.',
        CustomerNoResponse = '%s не ответил на ваш заказ.',
        HitmanNoResponse = 'Вы не успели ответить вовремя.',
        TargetRejectHit = 'Вы не можете делать заказы на этого человека.',
        InvalidTargets = 'Не удалось сделать заказ. Клиент(ы) вышел(ли) с сервера либо вы мертвы.',
        CustomerOnHitAccepted = '%s принял ваш заказ на %s. Деньги были переданы.',
        CustomerOnHitDeclined = '%s отказал в вашем заказе.',
        HitmanOnHitAccepted = 'Вы приняли заказ %s\'s на %s за %s.',
        HitmanOnHitDeclined = 'Вы отменили заказ %s\'s.',
        MessageAllOnAccepted = 'Кто-то принял заказ. Будьте бдительны, возможно вы и есть цель.',
        BonusWeaponHitComplete = '%s completed the hit using the %s against %s. They have been rewarded with %s and a bonus of %s.',
        HitCompletedNoBonus = '%s завершил заказ на %s и получил %s.',
        TaxOnKill = 'Ваша прибыль облагается налогом ' .. Executioner.Config.TaxOnKill .. '%.',
        TargetDiedBeforeHit = 'Цель была убита до того как исполнитель добрался до неё. Заказ провален!',
        TargetKilledHitman = 'Исполнитель был убит целью. Заказ провален!',
        HitmanDied = 'Исполнитель был убит до того как смог добраться до цели. Заказ провален!',
        TargetDisconnected = 'Цель покинула сервер. Деньги возвращены заказчику.',
        HitmanDisconnected = 'Исполнитель покинул сервер. Деньги возвращены.',
        CustomerDisconnected = 'Заказчик покинул сервер. Заказ был удалён.',
        HitmanChangedJob = 'Исполнитель сменил работу. Деньги возвращены заказчику.', -- REMOVE
        HitmanArrested = 'Исполнитель был арестован. Деньги возвращены.',
        TargetArrested = 'Цель была арестована. Деньги возвращены.',
        PhoneNoSave = 'Нечего сохранять.',
        PhoneOnSave = 'Телефон %i был успешно сохранён.',
        PhoneOnReset = 'Успешно удалены телефоны %i, а так же перезагружена дата.',
        OnSwitchTeam = '%s изменился на %s. Деньги возвращены.',
        BonusNoReply = 'You took too long to reply to the Bonus Weapon offer.',
        HitActive = 'Этот человек уже участник заказа. Вы не можете сейчас сделать на него заказ.',
        SameTargetTooSoon = 'Этот человек уже был кем-то заказан ранее, вы не можете сделать ещё один заказ прямо сейчас.',
        CantDrop = 'You can not drop a Bonus Weapon.',
        --> Start of Phone Related Messages <--
        OnRandomHit = 'Аноним сделал заказ на подозреваемого. Больше информации узнайте по ' .. Executioner.Config.Phone_Command .. '.',
        OnRadomHitAccepted = 'Вы приняли случайно сгенерированный заказ на %s за %s.',
        HitmanActiveHit = 'Вы уже выполняете заказ. Вы не можете взять ещё один сейчас.',
        NotEnoughHitmen = 'На сервере нет исполнителей, вы не можете сделать заказ.',
        CustomerOnPhoneHitPlaced = 'Вы сделали заказ на %s. Исполнитель скоро возьмёться за него.',
        HitmanNotifyRequest = '%s сделал заказ. Больше информации по ' .. Executioner.Config.Phone_Command .. '.',
        PhoneNotInService = 'Телефон сейчас не работает, подойдите позже.',
        HitmanOnUsePhone = 'Вы не можете пользоваться телефоном за исполнителя.'
    }
