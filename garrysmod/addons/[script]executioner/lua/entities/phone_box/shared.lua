    ...
    if CLIENT then
        ...
        function ENT:Use( null, caller, type )
            ...
            if Executioner.Config.No_Place_Teams[ team.GetName( caller:Team() ) ] then Executioner.SendMessage( caller, 'Вы не можете делать заказы в этой профессии.' ) return end
