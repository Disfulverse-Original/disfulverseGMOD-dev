...
hook.Add("HUDPaint", "rsrp_drawpoliceradio", function()
    ...
    draw.SimpleText(string.format("Текущий канал: %s (G)", currentChannel), "rsrp_policeradio30", ScrW()*0.99, ScrH()*0.48, Color( 255, 255, 255, 150 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
    draw.SimpleText(string.format("Рация.Голос %s (H)", (radioState and "вкл.") or "откл."), "rsrp_policeradio30", ScrW()*0.99, ScrH()*0.5, (radioState and Color(250, 210, 35, 150 )) or Color( 255,255,255, 150 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
    draw.SimpleText(string.format("Рация.Звук %s (I)", (recievedAudioState and "вкл.") or "откл."), "rsrp_policeradio30", ScrW()*0.99, ScrH()*0.52, (recievedAudioState and Color(250, 210, 35, 150 )) or Color( 255,255,255, 150 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
end)
