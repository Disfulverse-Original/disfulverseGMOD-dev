...
net.Receive("RealisticPolice:HandCuff", function(len, ply)
    ...
    if RPTString == "ArrestPlayer" then  
        ...
        if IsValid(ply.WeaponRPT["Drag"]) && ply.WeaponRPT["Drag"].WeaponRPT["Cuff"] then 
            ...
            -- Arrest the Player 
            Realistic_Police.ArresPlayer(ply.WeaponRPT["Drag"], RPTInt*Realistic_Police.DayEqual)
            Realistic_Police.SendNotify(ply.WeaponRPT["Drag"], Realistic_Police.Lang[82][Realistic_Police.Langage].." "..ply:Name())
            Realistic_Police.SendNotify(ply, Realistic_Police.Lang[83][Realistic_Police.Langage].." "..ply.WeaponRPT["Drag"]:Name())
