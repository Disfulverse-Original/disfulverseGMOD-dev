...
net.Receive("RealisticProperties:ModificationNpc", function() 
    ...
    if #RealisticPropertiesTable == 0 then RealisticPropertiesNotify( Realistic_Properties.Lang[47][Realistic_Properties.Language], 3 ) return end 
    ...
    RealisticPropertiesFrame.Paint = function(self,w,h)
        ...
        draw.SimpleText(string.upper(Realistic_Properties.Lang[7][Realistic_Properties.Language]), "rps_font_5", w*0.01, h*0.02, color_white, TEXT_ALIGN_LEFT)
    end 
    ...
    RealisticPropertiesDButton.Paint = function(self,w,h)
        if table.HasValue(RealisticPropertiesTableEnt, RealisticPropertiesTable[RealisticPropertiesChoose]["RealisticPropertiesName"]) then 
            ...
            draw.SimpleText(Realistic_Properties.Lang[56][Realistic_Properties.Language], "rps_font_5", w/2, h/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        else 
            draw.RoundedBox(8, 0, 0, w, h, Realistic_Properties.Colors["redwhite"])
            draw.SimpleText(string.upper(Realistic_Properties.Lang[58][Realistic_Properties.Language]), "rps_font_5", w/2, h/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        end 
    end 
...
net.Receive("RealisticProperties:PropertiesAdd", function() -- Admin Menu 
    ...
    RealisticPropertiesFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(string.upper(Realistic_Properties.Lang[7][Realistic_Properties.Language]), "rps_font_1", w*0.015, h*0.018, Realistic_Properties.Colors["white"], TEXT_ALIGN_LEFT)
        draw.DrawText(Realistic_Properties.Lang[17][Realistic_Properties.Language].." "..math.Round(square).." m²", "rps_font_3", w*0.015, RealisticPropertiesFrame:GetTall()*0.875, Realistic_Properties.Colors["white"], TEXT_ALIGN_LEFT)
    end 
    ...
    RealisticPropertiesDTextEntry1:SetText(" "..Realistic_Properties.Lang[11][Realistic_Properties.Language])
    ...
    RealisticPropertiesDTextEntry1.OnGetFocus = function(self) 
        if RealisticPropertiesDTextEntry1:GetText() == " "..Realistic_Properties.Lang[11][Realistic_Properties.Language] then 
    ...
    RealisticPropertiesDTextEntry2:SetText(" "..Realistic_Properties.Lang[12][Realistic_Properties.Language])
	...
	RealisticPropertiesDTextEntry2.OnGetFocus = function(self) 
        if RealisticPropertiesDTextEntry2:GetText() == " "..Realistic_Properties.Lang[12][Realistic_Properties.Language] then 
    ...
    RealisticPropertiesDCombobox1:SetText(Realistic_Properties.Lang[13][Realistic_Properties.Language])
    ...
    RealisticPropertiesDCombobox1:AddChoice(Realistic_Properties.Lang[8][Realistic_Properties.Language])
    RealisticPropertiesDCombobox1:AddChoice(Realistic_Properties.Lang[10][Realistic_Properties.Language])
    ...
    RealisticPropertiesDCombobox2:SetText(Realistic_Properties.Lang[14][Realistic_Properties.Language])
    ...
    if RealisticPropertiesEditProperties then 
        ...
        RealisticPropertiesDCombobox3:SetText(Realistic_Properties.Lang[18][Realistic_Properties.Language])
        ...
        RealisticPropertiesDCombobox3.OnSelect = function(index, id, data)
            if RealisticPropertiesTableAll[id]["RealisticPropertiesLocationId"] == 1 then 
                RealisticPropertiesDCombobox1:SetValue(Realistic_Properties.Lang[8][Realistic_Properties.Language]) 
            elseif RealisticPropertiesTableAll[id]["RealisticPropertiesLocationId"] == 3 then
                RealisticPropertiesDCombobox1:SetValue(Realistic_Properties.Lang[10][Realistic_Properties.Language]) 
            end
    ...
    RealisticPropertiesButtonAccept:SetText(Realistic_Properties.Lang[15][Realistic_Properties.Language])
    ...
    RealisticPropertiesButtonAccept.DoClick = function()
        ...
        if RealisticPropertiesDCombobox1:GetValue() == Realistic_Properties.Lang[8][Realistic_Properties.Language] then 
            RealisticPropertiesLocationId = 1 
        elseif RealisticPropertiesDCombobox1:GetValue() == Realistic_Properties.Lang[10][Realistic_Properties.Language] then
        ...
        if isstring(RealisticPropertiesTable["RealisticPropertiesName"]) and IsValid(RealisticPropertiesDCombobox3) then
            if RealisticPropertiesDTextEntry1:GetValue() ~= RealisticPropertiesTable["RealisticPropertiesName"] and CheckIfExist(RealisticPropertiesTableAll, RealisticPropertiesDTextEntry1:GetValue()) then
                RealisticPropertiesNotify(Realistic_Properties.Lang[54][Realistic_Properties.Language], 3)
                return
            end
        ...
        if isstring(RealisticPropertiesDTextEntry1:GetValue()) && isnumber(RealisticPropertiesNumber) && istable(RealisticPropertiesTable) && isstring(RealisticPropertiesDCombobox2:GetValue()) then 
           if RealisticPropertiesDTextEntry1:GetValue() != " "..Realistic_Properties.Lang[11][Realistic_Properties.Language] && RealisticPropertiesDCombobox2:GetValue() != Realistic_Properties.Lang[14][Realistic_Properties.Language] && RealisticPropertiesDCombobox1:GetValue() != Realistic_Properties.Lang[13][Realistic_Properties.Language] then 
                    ...
                    if tonumber(RealisticPropertiesDTextEntry2:GetValue()) > 0 then 
                        if string.len(string.Trim(RealisticPropertiesDTextEntry1:GetValue())) >= 3 then 
                            if string.len(string.Trim(RealisticPropertiesDTextEntry1:GetValue())) <= 20 then 
                                ...
                                RealisticPropertiesNotify( Realistic_Properties.Lang[57][Realistic_Properties.Language], 3 )   
                            end
                        else 
                            RealisticPropertiesNotify( Realistic_Properties.Lang[63][Realistic_Properties.Language], 3 )   
                        end 
                    else 
                        RealisticPropertiesNotify( Realistic_Properties.Lang[61][Realistic_Properties.Language], 3 )
                    end 
                else 
                    RealisticPropertiesNotify( Realistic_Properties.Lang[55][Realistic_Properties.Language], 3 )
                end 
            end 
        end
    ...
    RealisticPropertiesButtonDelete:SetText(Realistic_Properties.Lang[16][Realistic_Properties.Language])
    ...
    RealisticPropertiesButtonDelete.DoClick = function()
        ...
        if IsValid(RealisticPropertiesDCombobox3) then 
            if RealisticPropertiesDCombobox3:GetValue() != Realistic_Properties.Lang[18][Realistic_Properties.Language] then 
                net.Start("RealisticProperties:PropertiesRemove")
                net.WriteUInt(RealisticPropertiesIdDelete, 32)
                net.SendToServer()
            end
...
net.Receive("RealisticProperties:BuySellProperties", function() -- Main Menu 
    ...
    for k,v in pairs(RealisticPropertiesTable) do 
        if not table.HasValue(RealisticPropertiesTableEnt, v.RealisticPropertiesName) && not RealisticPropertiesTable[k]["RealisticPropertiesBuy"] then 
    ...
    timer.Simple(RealisticPropertiesInt, function()
        ...
        RealisticPropertiesFrame.Paint = function(self,w,h)
            ...
            draw.DrawText("♔ "..string.upper(Realistic_Properties.Lang[7][Realistic_Properties.Language ]), "rps_font_4", w*0.02, h*0.069, Realistic_Properties.Colors[RealisticPropertiesTheme]["white"], TEXT_ALIGN_LEFT)
            draw.DrawText("☎ "..string.upper(RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesName"]), "rps_font_4", w*0.58, h*0.19, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_CENTER)    
            surface.SetDrawColor( Realistic_Properties.Colors[RealisticPropertiesTheme]["white"] )
            surface.SetMaterial(Material("rps_materials2.png"))
            surface.DrawTexturedRect( w*0.035, h*0.5425, RpRespX*0.01717, RpRespY*0.196)
            draw.DrawText(Realistic_Properties.Lang[19][Realistic_Properties.Language].." : "..DarkRP.formatMoney(RealisticPropertiesPrice), "rps_font_5", w*0.065, h*0.542, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_LEFT)    
            if istable(RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesDoorId"]) then 
                draw.DrawText(Realistic_Properties.Lang[22][Realistic_Properties.Language].." : "..table.Count(RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesDoorId"]), "rps_font_5", w*0.065, h*0.6095, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_LEFT)
            else
                draw.DrawText(Realistic_Properties.Lang[22][Realistic_Properties.Language].." : 1", "rps_font_5", w*0.04, h*0.6095, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_LEFT)
            end 
            if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesLocationId"] == 1 then 
                draw.DrawText(Realistic_Properties.Lang[23][Realistic_Properties.Language], "rps_font_5", w*0.065, h*0.678, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_LEFT)
            else
                draw.DrawText(Realistic_Properties.Lang[24][Realistic_Properties.Language], "rps_font_5", w*0.065, h*0.678, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_LEFT)
            end  
            draw.DrawText(Realistic_Properties.Lang[25][Realistic_Properties.Language].." : "..RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesType"], "rps_font_5", w*0.065, h*0.748, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_LEFT) 
        end 
        ...
        function RealisticPropertiesFrameCam1:Paint( w, h )
            local x, y = self:GetPos()
            render.RenderView( {
                origin = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][1],
                angles = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][2],
                x = x, y = y,
                w = w, h = h,
                drawhud = false, 
            } )
        ...
        function RealisticPropertiesFrameCam2:Paint( w, h )
            local x, y = self:GetPos()
            render.RenderView( {
                origin = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][RealisticPropertiesIdChoose],
                angles = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][RealisticPropertiesIdChoose + 1],
                x = x, y = y,
                w = w, h = h,
                drawhud = false, 
            } )
        ...
        for i=1, 3 do 
            ...
            RealisticPropertiesButtonImage.DoClick = function() 
                ...
                elseif i == 2 then 
                    RealisticPropertiesIdChoose = 3 
                elseif i == 3 then 
                    RealisticPropertiesIdChoose = 5 
                end 
            end 
            ...
            elseif i == 2 then 
                function RealisticPropertiesFrameCam3:Paint( w, h )
                    local x, y = self:GetPos()
                    render.RenderView( {
                        origin = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][3],
                        angles = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][4],
                        x = x, y = y,
                        w = w, h = h,
                    } )
                end
            elseif i == 3 then 
                function RealisticPropertiesFrameCam3:Paint( w, h )
                    local x, y = self:GetPos()
                    render.RenderView( {
                        origin = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][5],
                        angles = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCam"][6],
                        x = x, y = y,
                        w = w, h = h,
                    } )
                end
        ...
        RealisticPropertiesButtonBuy:SetText(string.upper(Realistic_Properties.Lang[20][Realistic_Properties.Language]))
        ...
        RealisticPropertiesButtonBuy.DoClick = function()
            if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesBuy"] == true then 
                if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesOwner"] == LocalPlayer():SteamID64() then 
                    ...
                    RealisticPropertiesNotify( Realistic_Properties.Lang[65][Realistic_Properties.Language], 3 )
                end   
            ...
            elseif RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesBuy"] == false then 
                if istable(RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCantBuyJob"]) then 
                    if table.HasValue(RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesCantBuyJob"], team.GetName(LocalPlayer():Team())) then RealisticPropertiesNotify( Realistic_Properties.Lang[71][Realistic_Properties.Language], 3 ) return end 
                end
                if RealisticPropertiesCount < Realistic_Properties.MaxProperties then 
                    if RealisticPropertiesButtonBuy:GetText() != string.upper(Realistic_Properties.Lang[33][Realistic_Properties.Language]) then 
                        if LocalPlayer():getDarkRPVar("money") >= RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesPrice"] then 
                            ...
                            RealisticPropertiesNotify( Realistic_Properties.Lang[50][Realistic_Properties.Language], 3 )
                        end
                    ...
                    RealisticPropertiesNotify( Realistic_Properties.Lang[66][Realistic_Properties.Language].." "..Realistic_Properties.MaxProperties.." "..Realistic_Properties.Lang[67][Realistic_Properties.Language], 3 )
                end  
            end 
        end   

        local RealisticPropertiesDScroll = vgui.Create("DScrollPanel", RealisticPropertiesBaseFrame)
        RealisticPropertiesDScroll:SetSize(RpRespX*0.11, RpRespY*0.683) 
        ...
        if istable(RealisticPropertiesTable) then 
            ...
            for k, v in pairs(RealisticPropertiesTable) do 
                ...
                RealisticPropertiesFrameCamX[k].Paint = function(self,w,h)
                    ...
                    draw.DrawText(string.upper(RealisticPropertiesTable[k]["RealisticPropertiesName"]), "rps_font_7", RealisticPropertiesFrameCamX[k]:GetWide()/2, RpRespY*0.01, Realistic_Properties.Colors[RealisticPropertiesTheme]["black"], TEXT_ALIGN_CENTER)
                    draw.DrawText("•"..string.upper(Realistic_Properties.Lang[19][Realistic_Properties.Language]).." : "..DarkRP.formatMoney(RealisticPropertiesTable[k]["RealisticPropertiesPrice"]).." •", "rps_font_8", RealisticPropertiesFrameCamX[k]:GetWide()/2.03, RpRespY*0.035, Realistic_Properties.Colors[RealisticPropertiesTheme]["black330"], TEXT_ALIGN_CENTER)     
                end
                ...
                RealisticPropertiesButtonView:SetText(Realistic_Properties.Lang[21][Realistic_Properties.Language])
                ...
                RealisticPropertiesButtonView.DoClick = function()
                    ...
                    if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesBuy"] == true then 
                        if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesOwner"] == LocalPlayer():SteamID64() then  
                            RealisticPropertiesButtonBuy:SetText(Realistic_Properties.Lang[29][Realistic_Properties.Language])
                        else 
                            RealisticPropertiesButtonBuy:SetText(Realistic_Properties.Lang[26][Realistic_Properties.Language])
                        end 
                    else 
                        RealisticPropertiesButtonBuy:SetText(string.upper(Realistic_Properties.Lang[20][Realistic_Properties.Language]))
                    end 
                ...
                RealisticPropertiesSearch:SetValue(Realistic_Properties.Lang[53][Realistic_Properties.Language])
                ...
                RealisticPropertiesSearch.OnGetFocus = function(self) 
                    if RealisticPropertiesSearch:GetText() == Realistic_Properties.Lang[53][Realistic_Properties.Language] then 
                ...
                RealisticPropertiesSearch.OnLoseFocus = function(self)
                    if RealisticPropertiesSearch:GetText() == "" then  
                        RealisticPropertiesSearch:SetText(Realistic_Properties.Lang[53][Realistic_Properties.Language])
                    end
                end 
...
net.Receive("RealisticProperties:DeliveryMenu", function() -- Delivery menu 
    ...
    RealisticPropertiesBaseFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Properties.Lang[30][Realistic_Properties.Language], "rps_font_5", RealisticPropertiesBaseFrame:GetWide()/2, h*0.022, Realistic_Properties.Colors["white"], TEXT_ALIGN_CENTER)
    end 
    ...
    for k,v in pairs(RealisticPropertiesTableOwner) do
        ...
        RealisticPropertiesPanel[k]:SetText(Realistic_Properties.Lang[31][Realistic_Properties.Language].." : "..RealisticPropertiesBaseTable[v]["RealisticPropertiesName"])
...
function RealisticPropertiesRent(RealisticPropertiesTable, RealisticPropertiesId, RealisticPropertiesFrame)
    ...
    if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesLocationId"] == 1 then 
        ...
        RealisticPropertiesDComboboxRent:SetValue(Realistic_Properties.Lang[32][Realistic_Properties.Language])
        RealisticPropertiesDComboboxRent:AddChoice(Realistic_Properties.Lang[32][Realistic_Properties.Language])
        ...
        for i=2, Realistic_Properties.MaxRentalDay do 
            if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesBuy"] == false then
                RealisticPropertiesDComboboxRent:AddChoice(Realistic_Properties.Lang[33][Realistic_Properties.Language].." "..i.." "..Realistic_Properties.Lang[34][Realistic_Properties.Language],i)
            end 
        end 
        RealisticPropertiesDComboboxRent.OnSelect = function(index, value, data)
            if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesBuy"] == false then
                RealisticPropertiesClic()
                if value != 1 then 
                    RealisticPropertiesPrice = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesPrice"] * ( 1 + (value /10)) 
                    RealisticPropertiesButtonBuy:SetText(string.upper(Realistic_Properties.Lang[33][Realistic_Properties.Language]))
                else
                    RealisticPropertiesPrice = RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesPrice"]
                    RealisticPropertiesButtonBuy:SetText(string.upper(Realistic_Properties.Lang[20][Realistic_Properties.Language]))
                end 
...
function RealisticPropertiesOwner(RealisticPropertiesTable, RealisticPropertiesFrame, RealisticPropertiesId)
    ...
    if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesBuy"] == true then 
        if RealisticPropertiesTable[RealisticPropertiesId]["RealisticPropertiesOwner"] == LocalPlayer():SteamID64() then  
            ...
            RealisticPropertiesDCombobox4:SetText(Realistic_Properties.Lang[45][Realistic_Properties.Language])
