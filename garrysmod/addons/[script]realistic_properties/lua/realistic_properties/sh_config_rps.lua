...
Realistic_Properties.DayEqual = 0.5 -- If day = 1 (24h) , day = 0.5 (12h)
...
Realistic_Properties.DoorsLock = false -- If all doors which is in the data was lock 
...
Realistic_Properties.BuyEntitiesWithoutProperties = { -- Which job can buy entities without property when Realistic_Properties.PropertiesDelivery = false
    ["Продавец оружия"] = true,
    ["Контрабандист [Dis+]"] = true,
    ["Барахольщик [Dis+]"] = true,
    ["Детектив"] = true,
    ["Варщик мета"] = true,
    ["Крипто-Майнер"] = true,
}
