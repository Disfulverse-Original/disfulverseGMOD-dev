...
function Slawer.Jobs:GenerateFonts()
    ...
    surface.CreateFont("Slawer.Jobs:R22", { font = "Roboto", extended  = true, antialias = true, italic = false, weight = 1000, size = 21 }) -- desc iLastH * 0.021
    surface.CreateFont("Slawer.Jobs:SB22", { font = "Roboto", extended  = true, antialias = true, italic = false, weight = 1000, size = 20 }) -- job frame iLastH * 0.02
    ...
    surface.CreateFont("Slawer.Jobs:SB35", { font = "Roboto", extended  = true, antialias = true, italic = false, weight = 1000, size = iLastH * 0.022 }) -- job desc name iLastH * 0.022
