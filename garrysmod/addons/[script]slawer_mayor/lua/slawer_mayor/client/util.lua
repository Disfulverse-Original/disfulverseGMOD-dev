surface.CreateFont("Slawer.Mayor:B16", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 17 })
surface.CreateFont("Slawer.Mayor:B20", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 22 })
surface.CreateFont("Slawer.Mayor:B30", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 30 })
surface.CreateFont("Slawer.Mayor:B50", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 40 })
surface.CreateFont("Slawer.Mayor:B65", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 66 })
surface.CreateFont("Slawer.Mayor:B80", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 81 })
surface.CreateFont("Slawer.Mayor:B125", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 126 })
surface.CreateFont("Slawer.Mayor:R20", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 21 })
surface.CreateFont("Slawer.Mayor:R22", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 21 })
surface.CreateFont("Slawer.Mayor:R30", { font = "Roboto", extended  = true, italic = false, antialias = true, shadow = false, weight = 1000, size = 22 })
