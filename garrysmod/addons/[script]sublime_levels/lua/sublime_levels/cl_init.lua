...
function Sublime:DrawPanelTip(panel, str)
    ...
    local discol1 = Color(120, 185, 250,225)
    local discol2 = Color(0,0,0,255,230)

    tip.Paint = function(panel, w, h)
        draw.RoundedBox(8, 0, 0, w, h, discol1);
        draw.RoundedBox(8, 1, 1, w - 2, h - 2, discol2);
        self:DrawTextOutlined(str, "Sublime.16", w / 2, h / 2, c.White, c.Black, TEXT_ALIGN_CENTER, true);
    end
