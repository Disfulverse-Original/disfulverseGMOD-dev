Sublime.Languages["ru"] = 
{
    -- Main
        this_language = "Russian",
    --
    
    -- Home
        home_level              = "УРОВЕНЬ",
        home_total              = "СУММАРНО НАБРАННЫЕ УРОВНИ",
        home_experience         = "ОПЫТ",
        home_total_experience   = "СУММАРНО НАБРАННЫЙ ОПЫТ",
        home_available_points   = "ДОСТУПНЫЕ ОЧКИ НАВЫКОВ",
        home_spent_points       = "ПОТРАЧЕННЫЕ ОЧКИ НАВЫКОВ",
        home_strength           = "СИЛА",
        home_strength_total     = "СУММАРНЫЕ ПОТРАЧЕННЫЕ ОЧКИ НАВЫКОВ : СИЛА",
        home_agility            = "ЛОВКОСТЬ",
        home_agility_total      = "СУММАРНЫЕ ПОТРАЧЕННЫЕ ОЧКИ НАВЫКОВ : ЛОВКОСТЬ",
        home_intellect          = "ИНТЕЛЛЕКТ",
        home_intellect_total    = "СУММАРНЫЕ ПОТРАЧЕННЫЕ ОЧКИ НАВЫКОВ : ИНТЕЛЛЕКТ",
        home_leaderboards_rank  = "РЕЙТИНГ ЛИДЕРОВ",
        home_personal_stats     = "ПЕРСОНАЛЬНАЯ СТАТИСТИКА",
        home_global_stats       = "ГЛОБАЛЬНАЯ СТАТИСТИКА",
        home_home               = "ГЛАВНАЯ",
        home_players            = "ИГРОКИ",
        home_leaderboards       = "РЕЙТИНГ",
        home_skills             = "СПОСОБНОСТИ",
        home_options            = "НАСТРОЙКИ",
    --

    -- Players
        players_players     = "ИГРОКИ",
        players_online      = "ИГРОКИ В СЕТИ: %i/%i";
    --
    
    -- Leaderboards
        leaderboards_previous       = "Предыдущая Страница",
        leaderboards_next           = "Следующая Страница",
        leaderboards_player         = "Игрок",
        leaderboards_level          = "Уровень",
        leaderboards_experience     = "Опыт",
        leaderboards_t_experience   = "Суммарный Опыт",
    --

    -- Skills
        skills_strength     = "Физические атрибуты",
        skills_intellect    = "Интеллект",
        skills_agility      = "Ловкость",
        skills_skills       = "Навыки",
        skills_available    = "У вас %i Очков Навыков",
        skills_invalid      = "Неверно",
        skills_cant_afford  = "У вас недостаточно Очков Навыков.",
        skills_are_you_sure = "Вы уверены?",
        skills_unlock_conf  = "Вы уверены что хотите прокачать этот навык на ступень выше?",
        skills_unlock_fail  = "Сперва вам необходимо разблокировать смежный навык, для того чтобы открыть этот.",
        skills_enabled      = "Должна ли эта система навыков быть включена? Стандарт. Да.",
    --

    -- Options
        options_options = "Настройки",
        reset_database = "Сброс Датабазы",
    --

    -- Players
        players_name        = "Имя",
        players_level       = "Уровень",
        players_experience  = "Опыт",
    --

    -- Notifications
        notification_accept     = "Принять",
        notification_decline    = "Отменить",

        notification_give_level             = "Выдать Уровни",
        notification_give_level_desc        = "Как много уровней вы хотите выдать?",

        notification_take_level             = "Забрать Уровни",
        notification_take_level_desc        = "Сколько уровней вы хотите забрать?",

        notification_give_skill             = "Выдать Очки Навыков",
        notification_give_skill_desc        = "Сколько Очков Навыков вы хотите выдать?",

        notification_take_skill             = "Забрать Очки Навыков",
        notification_take_skill_desc        = "Сколько Очков Навыков вы хотите забрать?",

        notification_give_experience        = "Выдать опыт",
        notification_give_experience_desc   = "Вы можете выдать только недостающее кол-во опыта какому-либо игроку.",

        notification_reset_experience       = "Обнулить Опыт",
        notification_reset_experience_desc  = "Это обнулит кол-во опыта до 0.",
        

        notification_invalid_character_title    = "Неверные символы",
        notification_invalid_character_des      = "Ввод разрешен только чисел.",
        notification_player_invalid_title       = "Неверный игрок",
        notification_player_invalid_desc        = "Игрок, вероятно, вышел с сервера.",
        notification_max_level_title            = "Достигнут максимум",
        notification_max_level_desc             = "Макс. число уровней %s , иначе их уровень выйдет за лимит.",
        notification_invalid_value_title        = "Запрещённое число",
        notification_invalid_value_desc         = "Число должно быть выше 0.",
        notification_success_title              = "Запрос успешен",
        notification_success_desc               = "Ваш запрос на смену %s's был подтвержден.",
    --

    -- Client Settings
        client_settings     = "Клиент",
        client_saved        = "Настройки сохранены",
        client_save         = "Сохранить настройки",
        client_default      = "Сбросить настройки",
        client_change_key   = "Изменить Клавишу Меню",
        client_press_any    = "НАЖМИТЕ ЛЮБУЮ КЛАВИШУ",
        client_other_debug  = "Включить отображение debug сообщений в консоль игрока?",
        client_hud_display  = "Включить отображение HUD елементов на экране игрока?",
        client_hud_blur     = "Включить размытие вокруг меню?",
        client_hud_pos      = "Изменить позицию HUD",
        client_hud_bar      = "Использовать ли Линейный HUD вместо Радиального для отображения опыта?",
        client_xp_display   = "Отоброжать ли оповещение о полученном опыте?",
        menu_open           = "Кнопка для открытия меню Sublime Levels. Стандарт. F6",
        blur                = "Включить размытие вокруг меню? Стандарт. Да.",
        hud_y               = "Y позиция для HUD",
        hud_x               = "X позицию для HUD",
        hud_bar             = "Использовать ли Линейный HUD? Стандарт. Нет.",
        display             = "Включить ли отображение HUD для Sublime Levels. Стандарт. Да.",
        debug_enabled       = "Включить отображение debug сообщений в консоль игрока? Стандарт. Нет.",

        experience_notifications    = "Включить ли оповещение о полученном опыте в чат? Стандарт. Да.",
        hud_circle                  = "Использовать ли Радиальный HUD? Стандарт. Нет.",
        hud_modern                  = "Использовать ли Современный HUD? Стандарт. Да.",
    --
    ...
    -- Database settings.
    database_name = "Датабаза",

    --

    -- Skill settings.
        skill_settings = "Навыки",
    --
}