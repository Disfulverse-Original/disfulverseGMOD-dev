...
--
    surface.SetDrawColor(5, 0, 10, 150);
...
--
    ...
    --Sublime:DrawTextOutlined("", "Sublime.20", 8, 17, Sublime.Colors.White, Sublime.Colors.Black, TEXT_ALIGN_LEFT, true);
end
--]]
