...
net.Receive("Sublime.BroadcastLevelUp", function()
    ...
    chat.AddText(red, prefix, white, ": ", royal, nick, white, " дошел до ", red, tostring(level), white, " уровня",  white, "!");
end);
...
net.Receive("Sublime.ExperienceNotification", function()
    ...
    chat.AddText(red, prefix, white, ": ", royal, "Вы", white, " получили ", red, string.Comma(amount), white, " опыта " .. source);
end);
...
net.Receive("Sublime.UpgradeSkillNotify", function()
    ...
    chat.AddText(red, prefix, white, ": ", royal, "Вы", white, " улучшили ", red, skill, white, " до ", red, tostring(cAmount), white, "/", red, tostring(pCount));
end);   
