function YAWS.UI.ViewWarning(playerData, warnData)
    ...
    playersPanel.PerformLayout = function(self, w, h)
    ...
    goBackButton.DoClick = function()
        ...
        if(YAWS.UI.StateCache["warn_data_return"] == "viewing_player" || YAWS.UI.StateCache["warn_data_return"] == "viewing_self") then 
            YAWS.UI.CoreUI(true)
        end 
    end
