...
--[[function ENT:Draw()
    ...
    if ACC2.LocalPlayer:GetPos():DistToSqr(pos) < 800000 then
		local name = ACC2.GetSetting("npcRPNameName", "string") or ""
...
function ENT:Draw()
    ...
    if LocalPlayer():GetPos():DistToSqr(self:GetPos()) < 50000 then
        ...
        draw.RoundedBoxEx(20, -500, -3100, 1065, 170, Color(48, 47, 49, 245), true, true, false, false)
        draw.RoundedBox(0, -500, -2950, 1065, 20, Color(255, 255, 255, 255))
        draw.SimpleText(name, "NAMEEDIT2", 20, YPos - ((height + (2 * Padding)) / 2), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, 1 )

        local iconSize = 64
        surface.SetMaterial(iconMat1)
        surface.SetDrawColor(255, 255, 255, 255)
        surface.DrawTexturedRect(-iconSize / 0.15, YPos + (height / 200) - (iconSize / 0.72), iconSize, iconSize)
