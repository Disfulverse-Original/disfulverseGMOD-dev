...
local ServerAutoRestart_AdvertMsg = "[RST] Сервер перезагрузится через 15 минут."
...
local ServerAutoRestart_AdvertMsg2 = "[RST] Сервер перезагрузится через 10 минут."
...
local ServerAutoRestart_AdvertMsg3 = "[RST] Сервер перезагрузится через 5 минут."
...
local ServerAutoRestart_AdvertMsg5 = "[RST] Сервер перезагрузится через X минут."

local ServerAutoRestart_LangMin = "[RST] Сервер перезагрузится через 1 минуту !"
local ServerAutoRestart_LangSecs = "[RST] Сервер перезагрузится через %s секунд !" -- %s will be seconds here, do not edit it
local ServerAutoRestart_LangSec = "[RST] Сервер перезагрузится через 1 секунду !"
local ServerAutoRestart_LangRes = "[RST] ПЕРЕЗАПУСК СЕРВЕРА !"
